...
class economic_evaluation():
    ...
    def calculate_sLCOE(self, rated_rpm_array, D_rotor_array, Power_rated_array,
                      hub_height_array, aep_array, cabling_cost, Pitching_moment, moorings_cost, anchoring_cost, network_length):#cabling_cost=None):
        '''
    ...
    def calculate_expenditures(self, rated_rpm, rotor_diameter, rated_power,
                               hub_height, aep_array, cabling_cost, Pitching_moment, moorings_cost, anchoring_cost, network_length):#cabling_cost=None):
        ...
        self.calculate_capex(rated_rpm, rotor_diameter, rated_power,
                             hub_height, cabling_cost, Pitching_moment, moorings_cost, anchoring_cost, network_length)
    ...
    def calculate_capex(self, rated_rpm, rotor_diameter, rated_power, hub_height, cabling_cost, Pitching_moment, moorings_cost, anchoring_cost, network_length):#cabling_cost=None):
